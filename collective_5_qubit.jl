...
#@time P_C, P,basis,U_matrix=structure_of_peripheral_subspace(kraus_ops,1e-4,false);
@btime P_C, P,basis,U_matrix=structure_of_fixed_subspace(kraus_ops,1e-4,false);

#6.705 s (378320 allocations: 13.31 GiB)
#  5.543 s (378320 allocations: 13.31 GiB)
